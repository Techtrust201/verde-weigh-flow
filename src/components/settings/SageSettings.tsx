...
import { Save, Settings, Key, FileSpreadsheet, AlertCircle, CheckCircle } from 'lucide-react';
...
export default function SageSettings({ settings, onSettingsChange, onSave }: SageSettingsProps) {
  ...
  const hasApiKey = settings.cleAPISage && settings.cleAPISage.trim().length > 0;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Configuration API */}
        <Card className={hasApiKey ? "border-green-200 bg-green-50/50" : "border-orange-200 bg-orange-50/50"}>
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Cette clé permet la synchronisation automatique avec votre logiciel Sage
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className={hasApiKey ? 'text-foreground' : 'text-muted-foreground'}>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <div>
              <h4 className="font-medium text-sm mb-2">Étapes de configuration :</h4>
              <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
                <li>Connectez-vous à votre interface Sage</li>
                <li>Accédez aux paramètres d'API/intégrations</li>
                <li>Générez une nouvelle clé API avec les droits de lecture/écriture</li>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              ...
              <p className="text-xs text-blue-700">
                Contactez votre administrateur Sage ou notre support technique pour obtenir 
                assistance dans la configuration de l'API.
              </p>
            </div>
          </div>
        </CardContent>
