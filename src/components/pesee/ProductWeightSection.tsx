            ...
            <Card className="border-2 border-green-600 bg-white shadow-lg">
              <CardContent className="pt-6 pb-6">
                <div className="text-center mb-4">
                  <h3 className="text-2xl font-bold text-green-700 mb-2">💰 COÛT CALCULÉ</h3>
                  <div className="text-lg font-semibold text-gray-700 mb-1">
                    Poids net: <span className="text-green-600">{Math.abs((parseFloat(currentData.poidsEntree?.replace(',', '.')) || 0) - (parseFloat(currentData.poidsSortie?.replace(',', '.')) || 0)).toFixed(3)} tonnes</span>
                  </div>
                  {hasPrefPricing && (
                ...
                {hasPrefPricing && (
                  <div className="mt-4 text-center">
                    <Badge variant="outline" className="text-green-700 border-green-400 bg-green-50 font-semibold px-4 py-2">
